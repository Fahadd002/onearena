...
-- CreateEnum
CREATE TYPE "TurfStatus" AS ENUM ('ACTIVE', 'INACTIVE', 'REJECTED');
...
-- CreateEnum
CREATE TYPE "FixedPeriod" AS ENUM ('MONTHLY', 'QUARTERLY', 'HALF_YEARLY', 'YEARLY');
...
-- CreateEnum
CREATE TYPE "InvoiceFor" AS ENUM ('O', 'U');
...
CREATE TABLE "invoice" (
    ...
    "invoiceFor" "InvoiceFor" NOT NULL,
    "subtotal" DECIMAL(12,2) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "invoice_subscriptionLogId_key" ON "invoice"("subscriptionLogId");
...
-- CreateIndex
CREATE INDEX "subscription_log_subscriptionId_idx" ON "subscription_log"("subscriptionId");

-- CreateIndex
CREATE INDEX "subscription_log_endDate_idx" ON "subscription_log"("endDate");
...
-- AddForeignKey
ALTER TABLE "invoice" ADD CONSTRAINT "invoice_subscriptionLogId_fkey" FOREIGN KEY ("subscriptionLogId") REFERENCES "subscription_log"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "subscription_log" ADD CONSTRAINT "subscription_log_subscriptionId_fkey" FOREIGN KEY ("subscriptionId") REFERENCES "subscription"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
